...
public class PanelVuelos extends JPanel {
	...
	public void initComponents(Vuelo vuelo)
	{
		...
		panel_north.add(new JLabel(vuelo.getAeropuertoSalida().getNombre()));
		panel_north.add(new JLabel(vuelo.getAeropuertoDestino().getNombre()));
        
        JPanel panel_medio = new JPanel();
        panel_medio.add(new JLabel(Long.toString(vuelo.getSalida())));
        
        add(panel_north, BorderLayout.NORTH);
        add(panel_medio, BorderLayout.CENTER);
		
//		add(new JLabel(vuelo.getAeropuertoSalida().getNombre()), BorderLayout.NORTH);
//		add(new JLabel(vuelo.getAeropuertoDestino().getNombre()), BorderLayout.NORTH);
