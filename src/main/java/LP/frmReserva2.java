...
public class frmReserva2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmReserva2 frame = new frmReserva2();
	...
	public frmReserva2() {
		...
		JLabel lblNewLabel = new JLabel("AMS");
		...
		JLabel lblNewLabel_1_1 = new JLabel("Mie. 9 Sep");
		...
		JLabel lblNewLabel_5 = new JLabel("TARIFAS");
		...
		JRadioButton rdbtnNewRadioButton = new JRadioButton("Turista");
		...
		JLabel lblNewLabel_5_1_1_1 = new JLabel("Precio");
		...
		JLabel lblNewLabel_5_1_1_1_1 = new JLabel("Gast. Gestión");
		...
		JLabel lblNewLabel_7 = new JLabel("259,45 €");
		lblNewLabel_7.setBounds(163, 16, 69, 20);
		panel_2.add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("25,05 €");
		...
		JLabel lblNewLabel_10 = new JLabel("285,40 €");
		...
		JLabel lblNewLabel_11 = new JLabel("¿Cómo prefieres a pagar?");
		...
		Checkbox checkbox = new Checkbox("VISA");
		checkbox.setBounds(25, 42, 110, 50);
		panel_3.add(checkbox);
		
		Checkbox checkbox_1 = new Checkbox("PayPal");
